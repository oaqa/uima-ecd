...
public abstract class BaseExperimentBuilder implements ExperimentBuilder {
  ...
  public BaseExperimentBuilder(String experimentUuid, TypeSystemDescription typeSystem) {
  ...
  public <T extends Resource> T initializeResource(AnyObject config, String node, Class<T> type)
          throws Exception {
    AnyObject descriptor = config.getAnyObject("configuration");
    if (descriptor == null) {
      throw new IllegalArgumentException(
              "Illegal experiment descriptor, must contain one node of type <configuration>");
    }
    Map<String, Object> tuples = Maps.newLinkedHashMap();
  ...
  @Override
  public void insertExperiment(AnyObject config, String resource) throws Exception {
    ...
    insertExperiment(getExperimentUuid(), name, author, ConfigurationLoader.getString(resource),
            resource);
  }
  ...
  protected abstract void insertExperiment(final String id, final String name, final String author,
  ...
  public static <T extends Resource> List<T> createResourceList(Object o, Class<T> type) {
    ...
    if (o instanceof String) {
      ...
      resources = BaseExperimentBuilder.createResourceList(ao, type);
    } else {
