...
public final class SimplePipelineRev803 {
	 ...
	 * processing all CASes provided by the reader, the method calls
	 * {@link AnalysisEngine#collectionProcessComplete()
	 * collectionProcessComplete()} on the engines and
	 * {@link Resource#destroy() destroy()} on all engines.
	 * 
	 * @param reader
	 ...
	 * {@link CollectionReader#close() close()} on the reader and
	 * {@link Resource#destroy() destroy()} on the reader and all engines.
	 * 
	 * @param readerDesc
	 *            The CollectionReader that loads the documents into the CAS.
	 * @param descs
	 ...
	 * sequence of analysis engines. After processing all CASes provided by the
	 * reader, the method calls
	 * {@link AnalysisEngine#collectionProcessComplete()
	 * collectionProcessComplete()} on the engines.
	 * 
	 * @param reader
	 ...
	 * {@link JCas}. The result of the analysis can be read from the JCas.
	 * 
	 * @param aCas
	 *            the CAS to process
	 * @param aDescs
	 ...
	 * @throws IOException
	 */
	public static void runPipeline(final CAS aCas,
			final AnalysisEngineDescription... aDescs) throws UIMAException,
			IOException {
		// Create aggregate AE
	 ...
	 * @throws IOException
	 */
	public static void runPipeline(final JCas jCas,
			final AnalysisEngineDescription... descs) throws UIMAException,
			IOException {
	...
	/**
	 * Run a sequence of {@link AnalysisEngine analysis engines} over a
	 * {@link JCas}. This method does not {@link AnalysisEngine#destroy()
	 * destroy} the engines or send them other events like
	...
	/**
	 * Run a sequence of {@link AnalysisEngine analysis engines} over a
	 * {@link CAS}. This method does not {@link AnalysisEngine#destroy()
	 * destroy} the engines or send them other events like
	 * {@link AnalysisEngine#collectionProcessComplete()}. This is left to the
	 * caller.
	 * 
	 ...
	 * @throws IOException
	 */
	public static void runPipeline(final CAS cas,
			final AnalysisEngine... engines) throws UIMAException, IOException {
		for (AnalysisEngine engine : engines) {
			engine.process(cas);
		}
	 ...
	 */
	public static void collectionProcessComplete(
			final AnalysisEngine... engines)
