...
public class DefaultPhasePersistenceProvider extends AbstractPhasePersistenceProvider {
  ...
  @Override
  public void insertExecutionTrace(String optionId, String question, String sequenceId,
          String dataset, Integer phaseNo2, String uuid, long startTime, String hostName,
          String trace, String key) throws IOException {
