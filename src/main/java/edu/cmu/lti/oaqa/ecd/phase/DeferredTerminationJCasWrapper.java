...
class DeferredTerminationJCasWrapper implements JCas {
	...
	void invalidate() {
		// TODO: Fixme: this is one of the places where we hacked the timeout
		// solution
	...
	@Override
	public Feature getRequiredFeatureDE(Type t, String s, String rangeName,
			boolean featOkTst) {
		testLiveness();
	...
	@Override
	public Iterator<JCas> getViewIterator(String localViewNamePrefix)
			throws CASException {
		testLiveness();
