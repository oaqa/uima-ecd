...
public abstract class AbstractExperimentBuilder implements ExperimentBuilder {
  ...
  public AbstractExperimentBuilder(String experimentUuid, TypeSystemDescription typeSystem) {
