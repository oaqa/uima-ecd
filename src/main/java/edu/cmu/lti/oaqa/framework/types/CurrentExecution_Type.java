...
public class CurrentExecution_Type extends Annotation_Type {
	...
	private final FSGenerator fsGenerator = new FSGenerator() {
		public FeatureStructure createFS(int addr, CASImpl cas) {
			if (CurrentExecution_Type.this.useExistingInstance) {
				...
				FeatureStructure fs = CurrentExecution_Type.this.jcas
				...
				return new CurrentExecution(addr, CurrentExecution_Type.this);
		}
	};
	/** @generated */
	...
	public final static boolean featOkTst = JCasRegistry
			.getFeatOkTst("edu.cmu.lti.oaqa.framework.types.CurrentExecution");
	...
	public CurrentExecution_Type(JCas jcas, Type casType) {
		...
		casFeat_idHash = jcas.getRequiredFeatureDE(casType, "idHash",
				"uima.cas.String", featOkTst);
		casFeatCode_idHash = (null == casFeat_idHash) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_idHash).getCode();
