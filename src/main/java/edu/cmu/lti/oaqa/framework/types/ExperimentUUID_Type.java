...
public class ExperimentUUID_Type extends Annotation_Type {
	...
	private final FSGenerator fsGenerator = new FSGenerator() {
		public FeatureStructure createFS(int addr, CASImpl cas) {
			if (ExperimentUUID_Type.this.useExistingInstance) {
				...
				FeatureStructure fs = ExperimentUUID_Type.this.jcas
				...
				return new ExperimentUUID(addr, ExperimentUUID_Type.this);
		}
	};
	/** @generated */
	...
	public final static boolean featOkTst = JCasRegistry
			.getFeatOkTst("edu.cmu.lti.oaqa.framework.types.ExperimentUUID");
	...
	public ExperimentUUID_Type(JCas jcas, Type casType) {
		...
		casFeat_uuid = jcas.getRequiredFeatureDE(casType, "uuid",
				"uima.cas.String", featOkTst);
		casFeatCode_uuid = (null == casFeat_uuid) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_uuid).getCode();

		casFeat_stageId = jcas.getRequiredFeatureDE(casType, "stageId",
				"uima.cas.Integer", featOkTst);
		casFeatCode_stageId = (null == casFeat_stageId) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_stageId).getCode();
