...
public class ExperimentUUID extends Annotation {
	...
	public String getUuid() {
		if (ExperimentUUID_Type.featOkTst
				&& ((ExperimentUUID_Type) jcasType).casFeat_uuid == null)
			jcasType.jcas.throwFeatMissing("uuid",
					"edu.cmu.lti.oaqa.framework.types.ExperimentUUID");
		return jcasType.ll_cas.ll_getStringValue(addr,
				((ExperimentUUID_Type) jcasType).casFeatCode_uuid);
	}
	...
	public void setUuid(String v) {
		...
		jcasType.ll_cas.ll_setStringValue(addr,
				((ExperimentUUID_Type) jcasType).casFeatCode_uuid, v);
	}
	...
	public int getStageId() {
		if (ExperimentUUID_Type.featOkTst
				&& ((ExperimentUUID_Type) jcasType).casFeat_stageId == null)
			jcasType.jcas.throwFeatMissing("stageId",
					"edu.cmu.lti.oaqa.framework.types.ExperimentUUID");
		return jcasType.ll_cas.ll_getIntValue(addr,
				((ExperimentUUID_Type) jcasType).casFeatCode_stageId);
	}
	...
	public void setStageId(int v) {
		...
		jcasType.ll_cas.ll_setIntValue(addr,
				((ExperimentUUID_Type) jcasType).casFeatCode_stageId, v);
	}
}
