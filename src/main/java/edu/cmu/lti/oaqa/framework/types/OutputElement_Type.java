...
public class OutputElement_Type extends Annotation_Type {
	...
	private final FSGenerator fsGenerator = new FSGenerator() {
		public FeatureStructure createFS(int addr, CASImpl cas) {
			if (OutputElement_Type.this.useExistingInstance) {
				...
				FeatureStructure fs = OutputElement_Type.this.jcas
				...
				return new OutputElement(addr, OutputElement_Type.this);
		}
	};
	/** @generated */
	...
	public final static boolean featOkTst = JCasRegistry
			.getFeatOkTst("edu.cmu.lti.oaqa.framework.types.OutputElement");
