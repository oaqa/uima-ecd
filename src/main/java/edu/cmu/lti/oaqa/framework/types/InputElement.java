...
public class InputElement extends Annotation {
	 ...
	 * @generated
	 */
	protected InputElement() {/* intentionally empty block */
	}
	...
	public String getSequenceId() {
		if (InputElement_Type.featOkTst
				&& ((InputElement_Type) jcasType).casFeat_sequenceId == null)
			jcasType.jcas.throwFeatMissing("sequenceId",
					"edu.cmu.lti.oaqa.framework.types.InputElement");
		return jcasType.ll_cas.ll_getStringValue(addr,
				((InputElement_Type) jcasType).casFeatCode_sequenceId);
	}
	...
	public void setSequenceId(String v) {
		...
		jcasType.ll_cas.ll_setStringValue(addr,
				((InputElement_Type) jcasType).casFeatCode_sequenceId, v);
	}
	...
	public String getQuestion() {
		if (InputElement_Type.featOkTst
				&& ((InputElement_Type) jcasType).casFeat_question == null)
			jcasType.jcas.throwFeatMissing("question",
					"edu.cmu.lti.oaqa.framework.types.InputElement");
		return jcasType.ll_cas.ll_getStringValue(addr,
				((InputElement_Type) jcasType).casFeatCode_question);
	}
	...
	public void setQuestion(String v) {
		if (InputElement_Type.featOkTst
			...
			jcasType.jcas.throwFeatMissing("question",
					"edu.cmu.lti.oaqa.framework.types.InputElement");
		jcasType.ll_cas.ll_setStringValue(addr,
				((InputElement_Type) jcasType).casFeatCode_question, v);
	}
	...
	public String getAnswerPattern() {
		if (InputElement_Type.featOkTst
				&& ((InputElement_Type) jcasType).casFeat_answerPattern == null)
			jcasType.jcas.throwFeatMissing("answerPattern",
					"edu.cmu.lti.oaqa.framework.types.InputElement");
		return jcasType.ll_cas.ll_getStringValue(addr,
				((InputElement_Type) jcasType).casFeatCode_answerPattern);
	}
	...
	public void setAnswerPattern(String v) {
		if (InputElement_Type.featOkTst
			...
			jcasType.jcas.throwFeatMissing("answerPattern",
					"edu.cmu.lti.oaqa.framework.types.InputElement");
		jcasType.ll_cas.ll_setStringValue(addr,
				((InputElement_Type) jcasType).casFeatCode_answerPattern, v);
	}
	...
	public String getDataset() {
		if (InputElement_Type.featOkTst
				&& ((InputElement_Type) jcasType).casFeat_dataset == null)
			jcasType.jcas.throwFeatMissing("dataset",
					"edu.cmu.lti.oaqa.framework.types.InputElement");
		return jcasType.ll_cas.ll_getStringValue(addr,
				((InputElement_Type) jcasType).casFeatCode_dataset);
	}
	...
	public void setDataset(String v) {
		if (InputElement_Type.featOkTst
			...
			jcasType.jcas.throwFeatMissing("dataset",
					"edu.cmu.lti.oaqa.framework.types.InputElement");
		jcasType.ll_cas.ll_setStringValue(addr,
				((InputElement_Type) jcasType).casFeatCode_dataset, v);
	}
	...
	public String getQuuid() {
		if (InputElement_Type.featOkTst
				&& ((InputElement_Type) jcasType).casFeat_quuid == null)
			jcasType.jcas.throwFeatMissing("quuid",
					"edu.cmu.lti.oaqa.framework.types.InputElement");
		return jcasType.ll_cas.ll_getStringValue(addr,
				((InputElement_Type) jcasType).casFeatCode_quuid);
	}
	...
	public void setQuuid(String v) {
		if (InputElement_Type.featOkTst
			...
			jcasType.jcas.throwFeatMissing("quuid",
					"edu.cmu.lti.oaqa.framework.types.InputElement");
		jcasType.ll_cas.ll_setStringValue(addr,
				((InputElement_Type) jcasType).casFeatCode_quuid, v);
	}
}
