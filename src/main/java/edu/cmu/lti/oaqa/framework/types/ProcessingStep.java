...
public class ProcessingStep extends Annotation {
	 ...
	 * @generated
	 */
	protected ProcessingStep() {/* intentionally empty block */
	}
	...
	public int getPhaseId() {
		if (ProcessingStep_Type.featOkTst
				&& ((ProcessingStep_Type) jcasType).casFeat_phaseId == null)
			jcasType.jcas.throwFeatMissing("phaseId",
					"edu.cmu.lti.oaqa.framework.types.ProcessingStep");
		return jcasType.ll_cas.ll_getIntValue(addr,
				((ProcessingStep_Type) jcasType).casFeatCode_phaseId);
	}
	...
	public void setPhaseId(int v) {
		...
		jcasType.ll_cas.ll_setIntValue(addr,
				((ProcessingStep_Type) jcasType).casFeatCode_phaseId, v);
	}
	...
	public String getComponent() {
		if (ProcessingStep_Type.featOkTst
				&& ((ProcessingStep_Type) jcasType).casFeat_component == null)
			jcasType.jcas.throwFeatMissing("component",
					"edu.cmu.lti.oaqa.framework.types.ProcessingStep");
		return jcasType.ll_cas.ll_getStringValue(addr,
				((ProcessingStep_Type) jcasType).casFeatCode_component);
	}
	...
	public void setComponent(String v) {
		...
		jcasType.ll_cas.ll_setStringValue(addr,
				((ProcessingStep_Type) jcasType).casFeatCode_component, v);
	}
	...
	public String getCasId() {
		if (ProcessingStep_Type.featOkTst
				&& ((ProcessingStep_Type) jcasType).casFeat_casId == null)
			jcasType.jcas.throwFeatMissing("casId",
					"edu.cmu.lti.oaqa.framework.types.ProcessingStep");
		return jcasType.ll_cas.ll_getStringValue(addr,
				((ProcessingStep_Type) jcasType).casFeatCode_casId);
	}
	...
	public void setCasId(String v) {
		if (ProcessingStep_Type.featOkTst
			...
			jcasType.jcas.throwFeatMissing("casId",
					"edu.cmu.lti.oaqa.framework.types.ProcessingStep");
		jcasType.ll_cas.ll_setStringValue(addr,
				((ProcessingStep_Type) jcasType).casFeatCode_casId, v);
	}
}
