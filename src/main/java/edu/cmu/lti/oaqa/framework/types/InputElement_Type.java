...
public class InputElement_Type extends Annotation_Type {
	...
	private final FSGenerator fsGenerator = new FSGenerator() {
		public FeatureStructure createFS(int addr, CASImpl cas) {
			if (InputElement_Type.this.useExistingInstance) {
				...
				FeatureStructure fs = InputElement_Type.this.jcas
				...
				return new InputElement(addr, InputElement_Type.this);
		}
	};
	/** @generated */
	...
	public final static boolean featOkTst = JCasRegistry
			.getFeatOkTst("edu.cmu.lti.oaqa.framework.types.InputElement");
	...
	public String getSequenceId(int addr) {
		if (featOkTst && casFeat_sequenceId == null)
			jcas.throwFeatMissing("sequenceId",
	...
	public String getQuestion(int addr) {
		if (featOkTst && casFeat_question == null)
			jcas.throwFeatMissing("question",
					"edu.cmu.lti.oaqa.framework.types.InputElement");
	...
	public String getAnswerPattern(int addr) {
		if (featOkTst && casFeat_answerPattern == null)
			jcas.throwFeatMissing("answerPattern",
					"edu.cmu.lti.oaqa.framework.types.InputElement");
	...
	public InputElement_Type(JCas jcas, Type casType) {
		...
		casFeat_sequenceId = jcas.getRequiredFeatureDE(casType, "sequenceId",
				"uima.cas.String", featOkTst);
		casFeatCode_sequenceId = (null == casFeat_sequenceId) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_sequenceId).getCode();
		...
		casFeat_answerPattern = jcas.getRequiredFeatureDE(casType,
				"answerPattern", "uima.cas.String", featOkTst);
		casFeatCode_answerPattern = (null == casFeat_answerPattern) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_answerPattern).getCode();

		casFeat_dataset = jcas.getRequiredFeatureDE(casType, "dataset",
				"uima.cas.String", featOkTst);
		casFeatCode_dataset = (null == casFeat_dataset) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_dataset).getCode();

		casFeat_quuid = jcas.getRequiredFeatureDE(casType, "quuid",
				"uima.cas.String", featOkTst);
		casFeatCode_quuid = (null == casFeat_quuid) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_quuid).getCode();
