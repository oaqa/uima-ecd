...
public class ProcessingStep_Type extends Annotation_Type {
	...
	private final FSGenerator fsGenerator = new FSGenerator() {
		public FeatureStructure createFS(int addr, CASImpl cas) {
			if (ProcessingStep_Type.this.useExistingInstance) {
				...
				FeatureStructure fs = ProcessingStep_Type.this.jcas
				...
				return new ProcessingStep(addr, ProcessingStep_Type.this);
		}
	};
	/** @generated */
	...
	public final static boolean featOkTst = JCasRegistry
			.getFeatOkTst("edu.cmu.lti.oaqa.framework.types.ProcessingStep");
	...
	public String getComponent(int addr) {
		if (featOkTst && casFeat_component == null)
			jcas.throwFeatMissing("component",
					"edu.cmu.lti.oaqa.framework.types.ProcessingStep");
	...
	public ProcessingStep_Type(JCas jcas, Type casType) {
		...
		casFeat_phaseId = jcas.getRequiredFeatureDE(casType, "phaseId",
				"uima.cas.Integer", featOkTst);
		casFeatCode_phaseId = (null == casFeat_phaseId) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_phaseId).getCode();

		casFeat_component = jcas.getRequiredFeatureDE(casType, "component",
				"uima.cas.String", featOkTst);
		casFeatCode_component = (null == casFeat_component) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_component).getCode();

		casFeat_casId = jcas.getRequiredFeatureDE(casType, "casId",
				"uima.cas.String", featOkTst);
		casFeatCode_casId = (null == casFeat_casId) ? JCas.INVALID_FEATURE_CODE
				: ((FeatureImpl) casFeat_casId).getCode();
