...
and [uimaFIT](http://code.google.com/p/uimafit/), that allow the creation of declarative UIMA pipelines form a 
configuration file.

The ECD allows the declaration of combinatorial parameters on each ofthe options, a key component for [experiment configuration exploration](https://github.com/oaqa/cse-framework). 
